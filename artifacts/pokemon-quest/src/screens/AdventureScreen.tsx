  ...
  return (
    <div className="pq-fade flex flex-col gap-3 py-3">
      ...
      <div className="pq-card p-3 flex items-center justify-between">
        <div>
          <div className="text-[10px] uppercase tracking-widest text-green-400/80">Trainer</div>
      ...
      <div className="pq-card p-3">
        <div className="flex items-center justify-between mb-2">
          ...
          <select
            ...
            className="bg-slate-900/60 border border-green-400/30 text-slate-100 rounded-lg px-2 py-1 text-sm"
          >
            {LOCATIONS.map((l) => (
      ...
      <div>
        <div className="text-[10px] uppercase tracking-widest text-green-400/80 mb-1 px-1">Your Team ({state.team.length}/6)</div>
      ...
      <div className="grid grid-cols-3 gap-2 mt-1">
        ...
        <button className="pq-btn pq-btn-rose" onClick={() => dispatch({ type: "SET_SCREEN", screen: "card" })}>
          🚶 Follow
        </button>
