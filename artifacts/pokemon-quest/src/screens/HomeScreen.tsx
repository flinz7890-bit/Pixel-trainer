  ...
  return (
    <div className="pq-fade flex flex-col items-center gap-8 py-12">
      <div className="text-center">
        <div className="text-[11px] uppercase tracking-[.4em] text-teal-300/80 mb-2">Main Menu</div>
        <div
          className="font-pixel text-2xl"
          style={{
            background: "linear-gradient(180deg,#5eead4 0%,#2dd4bf 60%,#0f766e 100%)",
      ...
      <button
        className="text-[11px] text-teal-300/70 underline-offset-2 hover:underline"
